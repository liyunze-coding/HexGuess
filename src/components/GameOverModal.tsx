...
const getFeedbackMessage = (guessCount: number, gameWon: boolean) => {
    if (guessCount === 1) return "You sure you're not cheating? :P";
    if (guessCount === 2) return "You're pretty good at this!";
    if (guessCount === 3) return "That was excellent!";
    if (guessCount === 4) return "Bet you can do better than that!";
    if (guessCount === 5 && gameWon) return "Phew! That was close :D";
